...
const Detail: NextPage = () => {
  ...
  useEffect(() => {
    ...
    // if (userData?.userDetail?.user?.accountType && userData?.userDetail?.user?.accountType === "guest")
  ...
  const onValid = ({ firstName, lastName, address, city, province, postCode, phone }: UserDetailForm) => {
    ...
    // if (email === '') {
    //   return setError("formError", { message: "Email or Phone number are required. Please choose one" });
    // }
